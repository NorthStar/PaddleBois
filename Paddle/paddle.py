...
class word2vec:
    ...
    def __init__(self):
        ...
        if not os.path.isfile("embedding_table"):
            urllib.urlretrieve("https://s3.us-east-2.amazonaws.com/models.paddlepaddle/04.word2vec/embedding_table", "embedding_table")
        self.word_dict = dict()
        with open("word_dict", "r") as f:
            for line in f:
                key, value = line.strip().split(" ")
                self.word_dict[key] = value
        self.embedding_table = numpy.loadtxt("embedding_table", delimiter=",")
